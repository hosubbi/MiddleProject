	...
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
			...
			<body>
					...
					<form class="modal-content" action="modifyMember.do" method="post">
						<div class="container">
							...
							<div class="clearfix">
								...
								<button id="delete" type="submit" class="delbtn">회원탈퇴</button>
				...
				<form id="myFrm" action="deleteMember.do"></form>
				...
				<script>
					...
					document.querySelector('#delBtn').addEventListener('click', function(){
						...
						let id = document.querySelector('input[name="uidaa"]').value;
						let did = document.querySelector('input[name="del"]').value;
						
						myFrm.append(document.querySelector('input[name="uidaa"]'));
						myFrm.append(document.querySelector('input[name="del"]'));
						console.log(id);
						console.log(did);
						if(id.equals(did)){
							myFrm.action = 'deleteMember.do';
							let uid = document.getElementById('uidaa').value;
							alert(uid + "님 회원탈퇴가 완료되었습니다.")
						}else{
							alert("본인 아이디와 다릅니다.")
						}
