...
<div class="section">
	<div class="container">
		<div class="row justify-content-between">
					...
					<div class="img-property-slide">
						<c:forEach var="img" items="${img }">
							<img src="imgupload/${img.cafeimgRoute }" alt="Image"
								class="img-fluid" style="width: auto%; height: 600px;">
						</c:forEach>
					</div>
				</div>
			...
			<div class="col-lg-4">
				<c:if  test="${cafe.memberId == cafe.memberId && my != null}">
				...
				<p class="meta"><a href = "${cafe.cafeHomepage }">${cafe.cafeHomepage }</a></p>
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=9a733aaef61d32ce74673c3da316fefe&libraries=services">
